...
moco_image_target = cell(num_planes,1);
fpath1 = [save_dir_cuts '\' params_moco.im_target_fname];
...
if do_moco
    ...
    for n_pl = 1:num_planes
        ...
        if ~isempty(moco_image_target{n_pl})
            cuts_data{n_pl}.image_target_external = moco_image_target{n_pl};
